...
Die Zuordnung läuft über das Feld **Klasse / Kurs** aus Phase 1. Groß- und Kleinschreibung spielt keine Rolle, die Schreibweise sollte aber einheitlich sein. Ist ein iPad offline oder fehlt die Klassenangabe, erscheint nach kurzer Zeit eine Ersatzschaltfläche, mit der die Gruppe auch ohne automatische Prüfung fortfahren kann.
